 ...
 * @author Hp
 */
public class TeamCoachFrontPageController implements Initializable {
    ...
    @FXML
    private void trackPlayerRecordsOnClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("TrackPlayerRecords.fxml"));
        Parent root = loader.load();

        Scene personViewScene = new Scene(root);
        TrackPlayerRecordsController controller = loader.getController();
    ...
    @FXML
    private void viewApplicationsOnClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
